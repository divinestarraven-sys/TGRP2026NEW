      ...
      <div className="container-sacred py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          <div className="lg:col-span-1">
            ...
            <p className="text-moonlight-white/80 text-sm font-body leading-relaxed mb-4">
              The Garden Is Not Merely A Place — It Is A Way Of Life.
            </p>
            <p className="text-moonlight-white/80 text-xs font-body leading-relaxed mb-6">
            ...
            <div className="flex items-center gap-2 text-solarpunk-amber/80">
            ...
            <a
              ...
              className="mt-4 inline-flex items-center gap-2 text-moonlight-white/80 hover:text-solarpunk-biolum text-sm font-body transition-colors"
            >
          ...
          {footerLinks.map((section) => (
            <div key={section.title}>
              <h4 className="font-display text-sm tracking-widest text-solarpunk-amber/80 mb-4 uppercase">
                {section.title}
              </h4>
              <ul className="space-y-2">
                {section.links.map((link) => (
                  <li key={link.path + link.label}>
                    <Link
                      to={link.path}
                      className="text-moonlight-white/80 hover:text-solarpunk-biolum text-sm font-body transition-colors"
                    >
                      {link.label}
                    </Link>
                  </li>
        ...
        <div className="mt-12 pt-8 border-t border-solarpunk-moss/10 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="font-sacred text-solarpunk-amber/80 text-sm italic text-center sm:text-left">
        ...
        <div className="mt-6 text-center">
          <p className="text-moonlight-white/80 text-xs font-body">
            &copy; 2026 The Green Resonance Project. All Rights Reserved.
          </p>
          <p className="text-moonlight-white/80 text-[15px] font-body mt-1">
            &copy; Raven Star &amp; Kelly Murphy — The Green Resonance Framework — All Rights Reserved
          </p>
          <p className="text-moonlight-white/80 text-[15px] font-body mt-1 max-w-xl mx-auto leading-relaxed">
