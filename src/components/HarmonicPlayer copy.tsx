...
export default function HarmonicPlayer() {
  ...
  return (
    <>
      <motion.button
        className="shrink-0 w-14 h-14 rounded-full glass-bio flex items-center justify-center"
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            className="tool-panel fixed z-50 glass-solar rounded-2xl overflow-hidden"
            ...
            <div className="p-4 border-b border-solarpunk-moss/15">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-1">
                  <button
                    onClick={handlePause}
                    className="p-1.5 rounded-lg bg-cosmic-deep/50 text-moonlight-white/80 hover:text-moonlight-white transition-colors"
                  >
              ...
              <p className="text-[15px] font-body text-moonlight-white/80 mt-1">
              ...
              {frequencies.map((f, i) => (
                ...
                >
                  ...
                  <div className="flex-1 text-left">
                    <p className="text-xs font-display tracking-wider text-moonlight-white/80 group-hover:text-moonlight-white transition-colors">
                      {f.name}
                    </p>
                    <p className="text-[15px] font-body text-moonlight-white/80">{f.desc}</p>
                  </div>
                  <span className="text-[15px] font-display text-moonlight-white/80">{f.freq}Hz</span>
                </motion.button>
              ))}
            </div>
          </motion.div>
