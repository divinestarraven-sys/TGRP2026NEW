...
export const galleryImages: GalleryImage[] = [
  {
    src: '/Gallery/01-best-new-garden-map.webp',
  ...
  {
    src: '/Gallery/02-new-green-resonance-garden-map-delta.webp',
  ...
  {
    src: '/Gallery/03-really-good-for-poster.webp',
  ...
  {
    src: '/Gallery/04-six-pillars-latest-update.webp',
  ...
  {
    src: '/Gallery/05-six-pillars-rhythmic-weave-edition.webp',
  ...
  {
    src: '/Gallery/06-green-resonance-framework-six-pillars-maxres.webp',
  ...
  {
    src: '/Gallery/07-keys-to-the-kingdom-keys.webp',
  ...
  {
    src: '/Gallery/08-keys-to-the-kingdom-master-map.webp',
  ...
  {
    src: '/Gallery/09-phoenix-master-sigil.webp',
  ...
  {
    src: '/Gallery/10-green-resonance-workbook-cover.webp',
