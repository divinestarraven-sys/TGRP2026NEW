    ...
    <PageTransition>
      ...
      <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          <motion.p
            className="font-sacred text-gold-sacred/80 text-lg sm:text-xl max-w-xl mx-auto leading-relaxed"
                  ...
                  <div className="flex flex-col items-start gap-4">
                    ...
                    <div>
                      <div className="flex items-center gap-2 mb-2">
                        <span className="text-moonlight-white/80 font-display text-xs tracking-widest">
      ...
      <section className="section-padding bg-gradient-to-b from-cosmic-black via-cosmic-deep to-cosmic-black relative overflow-hidden">
        ...
        <div className="container-sacred relative z-10">
          ...
          <div className="hidden sm:flex flex-wrap items-center justify-center gap-2 max-w-4xl mx-auto">
            {transformationCycle.map((item, i) => (
              <div key={i} className="flex items-center gap-2">
                ...
                >
                  ...
                  <span className="font-display text-xs tracking-widest text-moonlight-white/80">
                    {item.stage}
                  </span>
                </motion.div>
                ...
                {i < transformationCycle.length - 1 && (
                  ...
                  >
                    <ArrowRight className="w-4 h-4 text-gold-sacred/80" />
                  </motion.div>
                )}
              </div>
            ))}
            ...
            >
              <div className="flex items-center gap-2 text-gold-sacred/80">
                <RotateCcw className="w-4 h-4" />
                <span className="font-sacred text-xs tracking-widest text-gold-sacred/80">
                  The cycle renews
                </span>
                <RotateCcw className="w-4 h-4" />
              </div>
          ...
          <div className="sm:hidden flex flex-col items-center gap-1 max-w-xs mx-auto">
            {transformationCycle.map((item, i) => (
              <div key={i} className="flex flex-col items-center">
                ...
                >
                  ...
                  <span className="font-display text-[15px] tracking-widest text-moonlight-white/80">
                    {item.stage}
                  </span>
                </motion.div>

                {i < transformationCycle.length - 1 && (
                  <ArrowRight className="w-3 h-3 text-gold-sacred/80 rotate-90 my-0.5" />
                )}
              </div>
            ))}

            <motion.div
              className="flex items-center gap-2 text-gold-sacred/80 mt-3"
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
              viewport={{ once: true }}
              transition={{ delay: 1.2, duration: 0.6 }}
            >
              ...
              <span className="font-sacred text-[15px] tracking-widest text-gold-sacred/80">
                The cycle renews
              </span>
            </motion.div>
          </div>
        ...
        <div className="container-sacred max-w-2xl mx-auto text-center">
          ...
          >
            <GlassCard gold className="p-8 sm:p-12">
              ...
              <p className="font-sacred text-moonlight-white/80 text-sm sm:text-base leading-relaxed mb-8 max-w-md mx-auto">
