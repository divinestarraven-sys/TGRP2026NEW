    ...
    <PageTransition>
      ...
      <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
          ...
          <motion.p
            className="font-sacred text-gold-sacred/80 text-sm tracking-[0.35em] mb-4"
          ...
          <motion.p
            className="font-body text-moonlight-white/80 text-base sm:text-lg max-w-3xl mx-auto mb-10 leading-relaxed"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            ...
            {monthlyCommunityTimetable.map((event, i) => (
              ...
              >
                <GlassCard solar className="p-5 h-full">
                  <p className="font-display text-[15px] tracking-widest text-solarpunk-biolum/80 uppercase mb-2">
                    {event.week}
                  </p>
                  <h3 className="font-display text-base tracking-wider text-gold-sacred mb-2">
                    {event.title}
                  </h3>
                  <p className="font-body text-moonlight-white/80 text-xs leading-relaxed">
                    {event.focus}
                  </p>
                </GlassCard>
              </motion.div>
      ...
      <section id="mycelium-paywall" className="section-padding bg-gradient-to-b from-cosmic-black via-cosmic-deep to-cosmic-black scroll-mt-20">
        <div className="container-sacred max-w-4xl mx-auto">
          ...
          <GlassCard gold className="p-8 sm:p-12 mb-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="font-body text-moonlight-white/80 leading-relaxed mb-4">
                  Join for{' '}
                ...
                <ul className="space-y-2 mb-4">
                  {['Weekly guided practices', 'New Moon Council', 'Resource library', 'Community events circle', 'All Seed Membership access'].map((b) => (
                    <li key={b} className="flex items-center gap-2 text-sm font-body text-moonlight-white/80">
                ...
                {!MYCELIUM_STRIPE_PAYMENT_LINK && (
                  <div className="p-4 rounded-xl bg-solarpunk-amber/8 border border-solarpunk-amber/20 text-xs font-body text-solarpunk-amber/80 leading-relaxed">
              ...
              <div className="rounded-2xl bg-cosmic-black/50 border border-gold-sacred/15 p-7 text-center">
                <p className="font-sacred text-gold-sacred/80 text-xs tracking-widest mb-3">MONTHLY ACCESS</p>
                <div className="flex items-end justify-center gap-2 mb-6">
                  <span className="font-display text-6xl text-moonlight-white">${MYCELIUM_PRICE_USD}</span>
                  <span className="font-body text-moonlight-white/80 mb-2">USD</span>
                </div>
                <button
                  onClick={handleJoin}
                ...
                <p className="font-body text-moonlight-white/80 text-xs mt-3 leading-relaxed">
          ...
          <GlassCard gold className="p-7 sm:p-9">
            ...
            <p className="font-body text-moonlight-white/80 text-sm mb-6">
            ...
            {formState === 'success' ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="mycelium-name" className="block font-display text-xs tracking-widest text-moonlight-white/80 mb-2">NAME</label>
                    <input
                      id="mycelium-name"
                      type="text"
                      value={name}
                      ...
                      className="w-full px-4 py-3 rounded-xl bg-cosmic-deep/50 border border-gold-sacred/10 text-sm font-body text-moonlight-white placeholder:text-moonlight-white/80 focus:outline-none focus:border-gold-sacred/30 transition-colors"
                    />
                  </div>
                  <div>
                    <label htmlFor="mycelium-email" className="block font-display text-xs tracking-widest text-moonlight-white/80 mb-2">EMAIL</label>
                    <input
                      id="mycelium-email"
                      type="email"
                      value={email}
                ...
                <div>
                  <label htmlFor="mycelium-interest" className="block font-display text-xs tracking-widest text-moonlight-white/80 mb-2">MEMBERSHIP INTEREST</label>
                  <select
                ...
                <div>
                  <label htmlFor="mycelium-message" className="block font-display text-xs tracking-widest text-moonlight-white/80 mb-2">MESSAGE (OPTIONAL)</label>
                  <textarea
                    id="mycelium-message"
                    value={message}
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-cosmic-deep/50 border border-gold-sacred/10 text-sm font-body text-moonlight-white placeholder:text-moonlight-white/80 focus:outline-none focus:border-gold-sacred/30 transition-colors resize-none"
                  />
                </div>
            ...
            {([
              ...
              >
                <GlassCard solar className="p-6 opacity-70">
                  <Icon className="w-8 h-8 text-gold-sacred/80 mx-auto mb-3" />
                  <h3 className="font-display text-base tracking-wider text-moonlight-white/80 mb-2">{title}</h3>
                  <div className="flex items-center justify-center gap-1.5 mt-3">
                    <Lock className="w-3 h-3 text-moonlight-white/80" />
                    <p className="font-body text-moonlight-white/80 text-xs">Locked until membership is active.</p>
                  </div>
                </GlassCard>
              </motion.div>
            ))}
        ...
        <div className="container-sacred text-center">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-3xl mx-auto">
            <GlassCard solar className="p-5">
              ...
              <p className="font-body text-moonlight-white/80 text-xs mb-3">The founding layer.</p>
              <Link
                to="/seed-membership"
            ...
            <GlassCard gold className="p-5">
              ...
              <p className="font-body text-moonlight-white/80 text-xs mb-3">The living archive.</p>
              <Link
                to="/codex"
            ...
            <GlassCard solar className="p-5">
              ...
              <p className="font-body text-moonlight-white/80 text-xs mb-3">The living network.</p>
              <Link
                to="/community"
