    ...
    <PageTransition>
      ...
      <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          <motion.p
            className="font-sacred text-gold-sacred/80 text-base sm:text-lg max-w-xl mx-auto leading-relaxed mb-3"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          <motion.p
            className="font-body text-moonlight-white/80 text-sm sm:text-base max-w-2xl mx-auto mb-10 leading-relaxed"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
      ...
      <section className="section-padding relative bg-gradient-to-b from-cosmic-black via-emerald-deep/5 to-cosmic-black">
        <div className="container-sacred relative z-10 max-w-3xl mx-auto text-center">
          ...
          />
          <motion.p
            className="font-body text-moonlight-white/80 text-base sm:text-lg leading-relaxed"
            initial={{ opacity: 0, y: 20 }}
            ...
            <GlassCard gold className="p-8 sm:p-10">
              ...
              <ul className="space-y-3 mb-6">
                {memberBenefits.map((benefit) => (
                  <li key={benefit} className="flex items-start gap-3 text-sm font-body text-moonlight-white/80">
              ...
              <div className="p-4 rounded-xl bg-emerald-glow/5 border border-emerald-glow/10">
                <p className="font-sacred text-moonlight-white/80 text-xs leading-relaxed italic">
              ...
              <Link key={item.title} to={item.path}>
                ...
                >
                  <GlassCard solar className="p-4 text-center h-full group cursor-pointer">
                    ...
                    <h4 className="font-display text-xs tracking-wider text-moonlight-white/80 group-hover:text-emerald-glow transition-colors leading-tight">
                      {item.title}
                    </h4>
                  </GlassCard>
                </motion.div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[
              ...
              <GlassCard key={item.title} solar delay={i * 0.1} className="p-5">
                ...
                <p className="font-body text-moonlight-white/80 text-xs leading-relaxed">{item.desc}</p>
              </GlassCard>
            ))}
          </div>
        </div>
          ...
          {formState === 'success' ? (
            <GlassCard gold className="p-8 text-center">
              ...
              >
                ...
                <p className="font-body text-moonlight-white/80 leading-relaxed text-sm">
            ...
            <GlassCard gold className="p-8 text-center">
              ...
              >
                ...
                <p className="font-body text-moonlight-white/80 leading-relaxed text-sm mb-4">
            ...
            <GlassCard gold className="p-8">
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  <label htmlFor="seed-name" className="block font-display text-xs tracking-widest text-moonlight-white/80 mb-2">NAME</label>
                  <input
                    id="seed-name"
                    type="text"
                    autoComplete="name"
                ...
                <div>
                  <label htmlFor="seed-email" className="block font-display text-xs tracking-widest text-moonlight-white/80 mb-2">EMAIL</label>
                  <input
                    id="seed-email"
                    type="email"
                    autoComplete="email"
                ...
                <div>
                  <label className="block font-display text-xs tracking-widest text-moonlight-white/80 mb-2">INTERESTS</label>
                      ...
                      <button
                        ...
                        className={`px-3 py-1.5 rounded-full text-xs font-display tracking-wider transition-all ${
                          interests.includes(opt)
                            ...
                            : 'bg-cosmic-deep/30 text-moonlight-white/80 border border-moonlight-white/10 hover:text-moonlight-white/80'
                        }`}
                      >
                        {opt}
                      </button>
                ...
                <div>
                  <label htmlFor="seed-message" className="block font-display text-xs tracking-widest text-moonlight-white/80 mb-2">MESSAGE (OPTIONAL)</label>
                  <textarea
                    id="seed-message"
                    value={message}
                ...
                <p className="font-body text-sm text-moonlight-white/80 leading-relaxed">
      ...
      <section className="section-padding bg-gradient-to-b from-cosmic-black via-emerald-deep/5 to-cosmic-black">
        <div className="container-sacred max-w-2xl mx-auto">
          <GlassCard gold className="p-7 sm:p-9 text-center">
            ...
            <p className="font-sacred text-gold-sacred/80 text-xs tracking-widest mb-2">READY TO GO DEEPER?</p>
            <h3 className="font-display text-2xl tracking-wider text-gradient-harvest mb-3">
              Mycelium Membership
            </h3>
            <p className="font-body text-moonlight-white/80 text-sm leading-relaxed mb-6">
        ...
        <div className="container-sacred text-center">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-2xl mx-auto">
            <GlassCard gold className="p-6 sm:p-8">
              ...
              <p className="font-body text-moonlight-white/80 text-sm mb-4">
      ...
      <GalleryShowcase category="resources" title="Explore the living workbook" limit={1} />
    </PageTransition>
  );
}
