    ...
    <PageTransition>
      ...
      <section className="section-padding relative">
        ...
        <div className="container-sacred relative z-10 max-w-3xl mx-auto text-center">
          ...
          />
          <motion.p
            className="font-body text-moonlight-white/80 text-lg leading-relaxed"
            initial={{ opacity: 0, y: 20 }}
        ...
        <div className="container-sacred relative z-10 max-w-4xl mx-auto">
          ...
          <GlassCard gold className="p-6 sm:p-8 overflow-x-auto">
            <div className="flex items-center justify-center gap-2 mb-6">
              <Music className="w-5 h-5 text-gold-sacred/80" />
              <span className="font-sacred text-gold-sacred/80 text-sm tracking-[0.2em]">ALCHEMICAL HARMONIC KEY</span>
            </div>

            <table className="w-full min-w-[480px]">
              <thead>
                <tr className="border-b border-gold-sacred/20">
                  <th className="font-display text-xs tracking-widest text-gold-sacred/80 pb-3 text-left">Note</th>
                  <th className="font-display text-xs tracking-widest text-gold-sacred/80 pb-3 text-left">Planet</th>
                  <th className="font-display text-xs tracking-widest text-gold-sacred/80 pb-3 text-left">Metal</th>
                  <th className="font-display text-xs tracking-widest text-gold-sacred/80 pb-3 text-left">Sign</th>
                  <th className="font-display text-xs tracking-widest text-gold-sacred/80 pb-3 text-left">Quality</th>
                </tr>
              </thead>
              <tbody>
                {harmonicKey.map((row, i) => (
                  ...
                  >
                    ...
                    <td className="py-3 pr-4">
                      <span className="font-body text-moonlight-white/80 text-sm">{row.sign}</span>
                    </td>
                    <td className="py-3">
                      <span className="font-body text-moonlight-white/80 text-sm italic">{row.quality}</span>
                    </td>
                  </motion.tr>
                ))}
              </tbody>
      ...
      <section className="section-padding bg-gradient-to-b from-cosmic-black via-cosmic-deep to-cosmic-black">
        <div className="container-sacred max-w-3xl mx-auto">
          <GlassCard className="p-6 sm:p-8 text-center">
            <p className="font-sacred text-moonlight-white/80 text-sm leading-relaxed mb-4">
            ...
            <p className="font-sacred text-moonlight-white/80 text-xs tracking-wider italic">
