...
function PortalMapNode({ portal, isCenter }: { portal: PortalData; isCenter: boolean }) {
  ...
  const fontSize = isCenter ? 'text-[15px] sm:text-xs' : 'text-[13.5px] sm:text-[15px]';
  ...
  return (
    ...
    >
      <span
        ...
        style={{ color: portal.color, fontSize: isCenter ? '1.5rem' : '1.125rem' }}
      >
        {portal.number}
      </span>
      <span
        className={`${fontSize} text-moonlight-white/80 font-body leading-tight text-center px-1 mt-0.5`}
      >
  ...
  return (
    ...
    >
      <svg viewBox="0 0 400 400" className="w-full h-auto">
        ...
        <text x={cx} y={cy + 3} textAnchor="middle" fill="#FFF8DC" fillOpacity="0.6" fontSize="10.5" fontFamily="Cinzel, serif">
          VII
        </text>
      </svg>
    </motion.div>
        ...
        >
          ...
          <div className="mt-4 flex items-center gap-4 flex-wrap">
            <div className="flex items-center gap-2">
              ...
              />
              <span className="font-body text-sm text-moonlight-white/80">
              ...
              <div className="mt-6 pt-6" style={{ borderTop: `1px solid ${portal.color}15` }}>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mb-6">
                  {portal.features.map((feature, j) => (
                    <div key={j} className="flex items-start gap-2 text-sm font-body text-moonlight-white/80">
    ...
    <PageTransition>
      ...
      <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          <motion.div
            ...
            className="mb-6"
          >
            <Compass className="w-10 h-10 mx-auto text-gold-sacred/80" />
          </motion.div>
          ...
          <motion.p
            className="font-sacred text-moonlight-white/80 text-lg sm:text-xl max-w-2xl mx-auto leading-relaxed mb-4"
          ...
          <motion.p
            className="font-display text-sm tracking-[0.3em] text-gold-sacred/80"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          <div className="md:hidden space-y-3">
            ...
            >
              ...
              <div className="min-w-0">
                ...
                <p className="font-body text-xs text-moonlight-white/80">{centralPortal.subtitle}</p>
              </div>
              <span
            ...
            {portals.map((p, i) => (
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <p className="font-body text-xs text-moonlight-white/80">{p.subtitle}</p>
                </div>
                <span
      ...
      <section className="section-padding relative bg-gradient-to-b from-cosmic-black via-cosmic-deep/50 to-cosmic-black">
        <div className="container-sacred">
          ...
          <motion.p
            className="text-center font-sacred text-moonlight-white/80 text-sm mt-8 max-w-lg mx-auto"
            initial={{ opacity: 0 }}
      ...
      <section className="section-padding relative">
        <div className="container-sacred max-w-2xl">
          <GlassCard gold className="p-8 sm:p-12 text-center">
            ...
            <p className="font-sacred text-moonlight-white/80 leading-relaxed mb-8 max-w-md mx-auto">
