    ...
    <PageTransition>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {weaveAspects.map((aspect, i) => (
              <GlassCard key={aspect.title} delay={i * 0.1} className="p-6 sm:p-8">
                ...
                <p className="font-body text-moonlight-white/80 leading-relaxed">{aspect.desc}</p>
              </GlassCard>
            ))}
          </div>
        </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="font-body text-moonlight-white/80 text-sm">{level.desc}</p>
                    </div>
                  </div>
      ...
      <section className="section-padding relative">
        ...
        <div className="container-sacred relative z-10">
          ...
          />
          <p className="font-body text-moonlight-white/80 text-center max-w-2xl mx-auto mb-10 leading-relaxed">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {sixPrinciples.map((principle, i) => (
              <GlassCard key={principle.title} delay={i * 0.1} className="p-6 sm:p-8">
                ...
                <p className="font-body text-moonlight-white/80 leading-relaxed">{principle.desc}</p>
              </GlassCard>
            ))}
          </div>
        </div>
