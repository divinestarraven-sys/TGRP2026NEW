    ...
    <GlassCard bio className="p-6 sm:p-8">
      <div className="flex items-start gap-4">
        ...
        <div>
          ...
          <p className="font-sacred text-moonlight-white/80 text-lg italic leading-relaxed">"{reflection}"</p>
        </div>
      </div>
    </GlassCard>
  );
    ...
    <PageTransition>
      ...
      <section ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          <motion.p
            className="font-sacred text-moonlight-white/80 text-lg sm:text-xl lg:text-2xl max-w-2xl mx-auto mb-4 leading-relaxed"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          <motion.p
            className="font-body text-moonlight-white/80 text-sm sm:text-base max-w-3xl mx-auto mb-10 leading-relaxed"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          <motion.p
            className="font-body text-moonlight-white/80 text-xs mt-6 max-w-xl mx-auto"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            {introColumns.map((col, i) => (
              <GlassCard key={col.title} solar delay={i * 0.15} className="p-6 sm:p-8 group">
                ...
                <p className="font-body text-moonlight-white/80 leading-relaxed">{col.desc}</p>
              </GlassCard>
            ))}
          </div>
        </div>
            ...
            {featuredSystems.map((system, i) => (
              <Link key={system.title} to={system.path}>
                <GlassCard solar delay={i * 0.08} className="p-5 sm:p-6 h-full group cursor-pointer">
                  ...
                  <p className="font-body text-moonlight-white/80 text-sm leading-relaxed">{system.desc}</p>
                </GlassCard>
              </Link>
            ))}
          </div>
              ...
              <Link key={pillar.title} to="/pillars">
                <GlassCard solar delay={i * 0.1} className="p-6 sm:p-8 h-full group cursor-pointer">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <span className="font-sacred text-xs tracking-widest text-moonlight-white/80 italic">"{pillar.key}"</span>
                  </div>
                  ...
                  <p className="font-body text-moonlight-white/80 text-sm leading-relaxed">{pillar.desc}</p>
                </GlassCard>
              </Link>
            ))}
          </div>
        ...
        <div className="relative z-10 container-sacred">
          ...
          >
            <div className="flex items-center justify-center gap-3 mb-4">
              <Star className="w-5 h-5 text-solarpunk-amber/80" />
              <h2 className="font-display text-3xl sm:text-4xl lg:text-5xl tracking-wider text-gradient-harvest">
                The Ravenstar
              </h2>
              <Star className="w-5 h-5 text-solarpunk-amber/80" />
            </div>
            <p className="font-sacred text-moonlight-white/80 text-lg sm:text-xl max-w-2xl mx-auto leading-relaxed">
        ...
        <div className="container-sacred relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <motion.div
              ...
              transition={{ duration: 0.8 }}
            >
              <Flame className="w-8 h-8 text-solarpunk-amber/80 mx-auto mb-4" />
              ...
              <p className="font-body text-moonlight-white/80 leading-relaxed mb-8">
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="font-display text-sm tracking-wider text-moonlight-white/80 group-hover:text-solarpunk-biolum transition-colors">
                        {cta.label}
                      </span>
                    </div>
                    <ArrowRight className="w-5 h-5 text-solarpunk-biolum/80 group-hover:text-solarpunk-biolum group-hover:translate-x-1 transition-all" />
                  </div>
                </Link>
              </motion.div>
            ))}
            ...
            {futureSystems.map((sys, i) => (
              <Link key={sys.title} to={sys.path}>
                <GlassCard gold delay={i * 0.1} className="p-6 sm:p-8 h-full group cursor-pointer">
                  ...
                  <span className="inline-flex items-center gap-2 font-display text-xs tracking-widest text-gold-sacred/80 group-hover:text-gold-sacred transition-colors">
                    Explore
      ...
      <section className="section-padding relative bg-gradient-to-b from-cosmic-black via-solarpunk-canopy/10 to-cosmic-black">
        <div className="container-sacred text-center">
          <GlassCard bio className="p-8 sm:p-12 max-w-2xl mx-auto">
            ...
            <p className="font-sacred text-moonlight-white/80 mb-6 leading-relaxed">
