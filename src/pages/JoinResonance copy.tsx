          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {tiers.map((tier, i) => (
              ...
              >
                ...
                <p className="font-body text-moonlight-white/80 text-sm mb-6">{tier.desc}</p>

                <ul className="space-y-2 mb-8 flex-1">
                  {tier.features.map((feature) => (
                    <li key={feature} className="flex items-start gap-2 text-sm font-body text-moonlight-white/80">
          ...
          <GlassCard gold className="p-6 sm:p-8 text-center">
            ...
            <div className="flex flex-col items-center gap-3">
              ...
              <Link
                ...
                className="inline-flex items-center gap-1.5 text-gold-sacred/80 hover:text-gold-sacred transition-colors font-sacred text-xs tracking-wide"
              >
          ...
          {formState === 'success' ? (
            ...
            <GlassCard gold className="p-8">
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  <label htmlFor="join-name" className="block font-display text-xs tracking-widest text-moonlight-white/80 mb-2">NAME</label>
                  <input
                    id="join-name"
                    type="text"
                    value={name}
                ...
                <div>
                  <label htmlFor="join-email" className="block font-display text-xs tracking-widest text-moonlight-white/80 mb-2">EMAIL</label>
                  <input
                    id="join-email"
                    type="email"
                    value={email}
                ...
                <div>
                  <label htmlFor="join-interest" className="block font-display text-xs tracking-widest text-moonlight-white/80 mb-2">INTEREST</label>
                  <select
                    id="join-interest"
                    value={interest}
