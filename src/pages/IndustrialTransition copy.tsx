    ...
    <PageTransition>
      ...
      <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          >
            <Factory className="w-5 h-5 text-gold-sacred/80" />
            <span className="font-sacred text-gold-sacred/80 text-sm tracking-[0.3em]">2026 – 2045+</span>
          </motion.div>
                ...
                <div className="flex-1 sm:w-1/2 pl-14 sm:pl-0 sm:px-8">
                  <GlassCard gold className="p-6">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <div>
                        <p className="font-sacred text-xs tracking-widest text-gold-sacred/80">{phase.phase}</p>
                        <p className="font-display text-xs text-moonlight-white/80">{phase.years}</p>
                      </div>
                    </div>
                    ...
                    <ul className="space-y-2">
                      {phase.items.map((item) => (
                        <li key={item} className="flex items-start gap-2 text-sm font-body text-moonlight-white/80 leading-relaxed">
                          <span className="text-gold-sacred/80 mt-0.5 shrink-0">·</span>
                          {item}
                        </li>
                      ))}
                    </ul>
                ...
                {productionEquation.formula.map((item, idx) => (
                  ...
                  >
                    <div className="flex items-center justify-center gap-3">
                      ...
                      {item.type === 'result' && <span className="text-gold-sacred/80 text-xs font-sacred">=</span>}
                      <span className={`font-display tracking-wider ${
                        item.type === 'result' ? 'text-gold-sacred text-lg' : 'text-moonlight-white/80 text-sm'
                      }`}>
                        {item.label}
                      </span>
                    </div>
        ...
        <div className="container-sacred">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 max-w-4xl mx-auto">
            <GlassCard solar className="p-8">
              ...
              <p className="font-body text-moonlight-white/80 text-sm">
                {sharedComputerModel.example}
              </p>
            </GlassCard>

            <GlassCard solar className="p-8">
              <Layers className="w-8 h-8 text-gold-sacred/80 mb-4" />
              <h3 className="font-display text-lg tracking-wider text-moonlight-white mb-3">
                Dedicated Systems Remain Appropriate
              </h3>
              <ul className="space-y-2">
                {sharedComputerModel.dedicatedUseCases.map((uc) => (
                  <li key={uc} className="flex items-start gap-2 text-sm font-body text-moonlight-white/80">
            ...
            <GlassCard solar className="p-8 lg:col-span-2">
              <Building2 className="w-8 h-8 text-solarpunk-biolum/80 mb-4" />
              <h3 className="font-display text-lg tracking-wider text-moonlight-white mb-3">
              ...
              <p className="font-body text-moonlight-white/80 text-sm mt-4 leading-relaxed">
