    ...
    <PageTransition>
      ...
      <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          >
            <Trophy className="w-5 h-5 text-gold-sacred/80" />
            <span className="font-sacred text-gold-sacred/80 text-sm tracking-[0.3em]">STEWARDSHIP, NOT OWNERSHIP</span>
          </motion.div>
          ...
          <div className="max-w-4xl mx-auto">
            <GlassCard solar className="p-8 sm:p-10">
              <div className="flex flex-col items-center gap-6">
                <Factory className="w-12 h-12 text-gold-sacred/80" />
                <p className="font-body text-moonlight-white/80 text-center leading-relaxed">
                ...
                <div className="flex flex-wrap items-center justify-center gap-3">
                  {[1, 2, 3, 4, 5].map((n) => (
                    <div key={n} className="flex flex-col items-center gap-1">
                      ...
                      <span className="font-body text-xs text-moonlight-white/80">~200</span>
                    </div>
                  ))}
                  <div className="w-16 h-16 rounded-xl border border-gold-sacred/30 flex items-center justify-center bg-gold-sacred/5">
                    <Factory className="w-7 h-7 text-gold-sacred/80" />
                  </div>
                </div>
                <p className="font-sacred text-moonlight-white/80 text-sm italic text-center max-w-md">
              ...
              >
                <GlassCard solar className="p-6 h-full group">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="font-display text-2xl tracking-wider text-gold-sacred/80">
                      {domain.weight}
                    </span>
                  </div>
            ...
            {safetyRequirements.map((req, i) => (
              ...
              >
                <GlassCard gold className="p-4 flex items-center gap-4">
                  ...
                  <span className="font-body text-moonlight-white/80 text-sm">{req}</span>
                </GlassCard>
              </motion.div>
            ))}
          </div>
        ...
        <div className="container-sacred">
          ...
          <div className="max-w-3xl mx-auto text-center mb-10">
            <GlassCard gold className="p-8">
              <p className="font-sacred text-gold-sacred/80 text-lg sm:text-xl tracking-wide leading-relaxed">
                "Governance rotates.
                <br />
            ...
            {masterStewards.map((steward, i) => (
              ...
              >
                <GlassCard solar className="p-4 text-center group h-full">
                  ...
                  <h4 className="font-display text-xs tracking-wider text-moonlight-white/80 leading-tight">
                    {steward.title}
                  </h4>
                </GlassCard>
              </motion.div>
          ...
          <div className="max-w-2xl mx-auto">
            <h3 className="font-display text-sm tracking-widest text-gold-sacred/80 mb-4 text-center">
              RESPONSIBILITIES
            </h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              {stewardResponsibilities.map((resp) => (
                <div key={resp} className="flex items-start gap-3 text-sm font-body text-moonlight-white/80">
                  <Award className="w-4 h-4 text-gold-sacred/80 shrink-0 mt-0.5" />
                  {resp}
                </div>
              ))}
            </div>
            <p className="font-sacred text-moonlight-white/80 text-sm italic text-center mt-6 max-w-md mx-auto leading-relaxed">
      ...
      <GalleryShowcase category="pillars" title="Practice before competition" limit={1} />
    </PageTransition>
  );
}
