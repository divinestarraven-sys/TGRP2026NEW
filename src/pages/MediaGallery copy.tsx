    ...
    <PageTransition>
      ...
      <section className="section-padding">
        <div className="container-sacred">
              ...
              <button
                ...
                className={`px-3.5 py-1.5 rounded-full text-xs font-display tracking-wider transition-all duration-300 ${
                  activeCategory === cat
                    ...
                    : 'text-moonlight-white/80 border border-moonlight-white/10 hover:text-moonlight-white/80 hover:border-moonlight-white/20'
                }`}
          ...
          {filtered.length === 0 && (
            <p className="text-center text-moonlight-white/80 font-sacred py-16">
            ...
            >
              ...
              <div className="mt-4 text-center">
                ...
                {currentImage.description && (
                  <p className="font-sacred text-moonlight-white/80 text-xs mt-1 max-w-lg mx-auto">
                    {currentImage.description}
                  </p>
                )}
                <p className="font-sacred text-moonlight-white/80 text-xs mt-2">
