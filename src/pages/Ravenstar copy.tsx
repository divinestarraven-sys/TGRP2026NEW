    ...
    <PageTransition>
      ...
      <section className="section-padding relative">
        ...
        <div className="container-sacred relative z-10 max-w-3xl mx-auto text-center">
          <motion.p
            className="font-sacred text-moonlight-white/80 text-lg sm:text-xl leading-relaxed sm:leading-relaxed"
            initial={{ opacity: 0, y: 30 }}
        ...
        <div className="container-sacred relative z-10">
          ...
          <div className="max-w-3xl mx-auto mb-16">
            <GlassCard gold className="p-8 sm:p-10 text-center">
              ...
              <p className="font-body text-moonlight-white/80 leading-relaxed text-sm sm:text-base">
          ...
          {/* Supporting Systems */}
          <motion.h3
            className="font-display text-lg tracking-wider text-center text-moonlight-white/80 mb-6"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          >
                ...
                <GlassCard key={sub.title} delay={i * 0.1} className="p-5 group">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="font-body text-moonlight-white/80 text-xs leading-relaxed">{sub.desc}</p>
                    </div>
                  </div>
                </GlassCard>
              );
              ...
              <ul className="space-y-3 mb-6">
                {ethicalProtocol.map((item, i) => (
                  ...
                  >
                    ...
                    <p className="font-body text-moonlight-white/80 text-sm leading-relaxed">{item}</p>
                  </motion.li>
                ))}
              </ul>
              <p className="font-body text-moonlight-white/80 text-xs leading-relaxed italic">
              ...
              {dailyPractice.map((item, i) => (
                <GlassCard key={i} delay={i * 0.06} className="p-4 sm:p-5">
                  <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
                    ...
                    <p className="font-sacred text-moonlight-white/80 text-sm italic leading-relaxed">
                      "{item.prompt}"
                    </p>
                  </div>
                </GlassCard>
