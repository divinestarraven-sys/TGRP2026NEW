                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <div className="flex items-center gap-2">
                            <span className="text-moonlight-white/80 font-display text-sm tracking-widest">
                          ...
                          <div className="flex items-center gap-2 mt-1">
                            <span className="font-sacred text-xs tracking-widest text-moonlight-white/80 italic">Portal Key: "{pillar.portalKey}"</span>
                          </div>
                          <p className="font-body text-moonlight-white/80 text-sm mt-1">{pillar.shortDesc}</p>
                        </div>
                      </div>
                      <motion.div
                      ...
                      >
                        <div className="mt-6 pt-6 border-t border-emerald-glow/10">
                          ...
                          <div className="flex items-center gap-2 mb-6">
                            <span className="text-xs font-display tracking-widest text-moonlight-white/80">CHAKRA</span>
                            <span className="text-xs font-sacred text-moonlight-white/80">{pillar.chakra}</span>
                          </div>
                          ...
                          <ul className="space-y-2 mb-6">
                            {pillar.practices.map((practice, j) => (
                              <li key={j} className="flex items-start gap-2 text-sm font-body text-moonlight-white/80">
            ...
            {pillars.map((p, i) => (
              <div key={p.portalKey} className="flex items-center gap-3">
                <div className="flex flex-col items-center gap-1">
                  ...
                  <span className="font-sacred text-[15px] text-moonlight-white/80 text-center leading-tight max-w-[80px]">
                    {p.portalKey.replace('I ', '')}
                  </span>
                </div>
                {i < pillars.length - 1 && <ArrowRight className="w-4 h-4 text-moonlight-white/80 mt-[-12px]" />}
              </div>
            ))}
          </motion.div>
        </div>
                ...
                {(() => {
                  ...
                  return (
                    <>
                      ...
                      <p className="font-body text-moonlight-white/80 leading-relaxed mb-6">{pillar.shortDesc}</p>
                      <div className="flex gap-3 justify-center">
                        <button
                          onClick={resetQuiz}
                          className="px-4 py-2 rounded-full glass text-sm font-display tracking-wider text-moonlight-white/80 hover:text-moonlight-white transition-colors"
                        >
                          Retake
                        </button>
                        <Link
