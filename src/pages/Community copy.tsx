...
export default function Community() {
  return (
    <PageTransition>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {communityValues.map((value, i) => (
              <GlassCard key={value.title} delay={i * 0.1} className="p-6 text-center">
                ...
                <p className="font-body text-moonlight-white/80 text-sm leading-relaxed">{value.desc}</p>
              </GlassCard>
            ))}
          </div>
        </div>
              ...
              <GlassCard key={event.title} delay={i * 0.1} className="p-6">
                <div className="flex flex-col sm:flex-row gap-4">
                  <div className="flex-1">
                    ...
                    <p className="font-body text-moonlight-white/80 text-sm leading-relaxed mb-3">{event.desc}</p>
                    <div className="flex items-center gap-4 text-xs text-moonlight-white/80">
      ...
      <GalleryShowcase category="garden" title="Stewardship in practice" limit={1} />
    </PageTransition>
  );
}
